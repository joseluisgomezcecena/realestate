    ...
    <br><br/>
        ...
        <?php foreach ($operations as $operation): ?>
            ...
            <table class="table" colspan="12">
                ...
                <tr>
                    <td colspan="2">Hora de inicio:<br></td>
                    <td colspan="2">Hora de termino:<br></td>
                ...
                ?>
                    ...
                    <td colspan="3">
                        ...
                        if ($custom_field['customfield_type'] == "checkbox"): ?>
                            <input type="checkbox" name="custom_fields[<?php echo $custom_field['customfield_id']; ?>][value]" value="on" >
                        <?php else: ?>
                            <?php echo " " ?>
                        <?php endif; ?>
                    </td>
                ...
                <tr>
                    <td colspan="2">Hora de salida:<br></td>
                    <td colspan="2">
                        Recibio:<br>
                    </td>
                    <td colspan="2">
