            ...
            <form action="<?php echo base_url("clients/create") ?>" method="post">
                <div class="row">
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="client_name" name="client_name" placeholder="Cliente" value="<?php echo set_value('client_name'); ?>">
                    ...
                    <div class="form-group col-lg-8" >
                        ...
                        <input type="text" class="form-control" id="ddress" name="address" placeholder="Dirección" value="<?php echo set_value('address'); ?>">
